...
import (
	"github.com/Xuzan9396/zinx-ws/v2/ziface"
...
// 初始化
func NewConnection(conn *websocket.Conn, connID uint32, callback_api ziface.HandleFunc) *Connection {
...
func (c *Connection) Start() {
	...
	for {
		...
		c.handleAPI(c.Conn, message, msgType)
	}
}
